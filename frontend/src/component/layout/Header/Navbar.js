      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-5">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="/ladiesc">Ladies Cloth</a></li>
            <li><a class="dropdown-item" href="/menc">Men Cloth</a></li>
            <li><a class="dropdown-item" href="ladiesw"> Ladies Watch</a></li>
            <li><a class="dropdown-item" href="/menc">Men Watch</a></li>
